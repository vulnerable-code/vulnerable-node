...
Exploit-and-fix notes for this intentionally vulnerable Node.js shop, inspired by [DVWA](https://github.com/digininja/DVWA). Findings map to the [OWASP Top 10:2025](https://owasp.org/Top10/2025/).
